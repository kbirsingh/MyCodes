...
$qry1="SELECT * FROM `employee` WHERE `id`='$id'";
...
if(isset($_POST['submit']))
{
    ...
    $qry="UPDATE `employee` SET `fullname`='$fullname',`email`='$email', `pnumber`='$pnumber',`address`='$address',`dob`='$dob',`username`='$username',`password`='$password' WHERE `id`='$id'";
...
<head>
    ...
    <style>
       body {
            background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(images/my-account2.jpg);
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-3">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h3 class="text-center" style="color: blueviolet; font-weight: bolder">Update Employee Details</h3>
              ...
              <form method="post">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <a href="view_employee.php" type="button" class="btn btn-outline-success btn-block btn gradient-custom-4 text-body-white" style="border: solid black 3px; margin-left: 12px; border-radius: 15px">Go Back</a>
                </div>
